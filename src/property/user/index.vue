  ...
  <div class="user">
    ...
    >
      ...
      >
        <div class="box-left">
          <VanIcon
            name="https://cube.elemecdn.com/3/7c/3ea6beec64369c2642b92c6726f1epng.png"
            size="55"
          />
        </div>
        <div class="box-right">
      ...
      >
        <template v-for="item in property" :key="item.type">
          <div class="item">
            <div
              class="number"
              :style="{
                color: data.numColor,
                fontSize: data.numSize + 'px'
              }"
            >
              <template v-if="item.type == 'coupon'">{{ '-' }}</template>
              <template v-if="item.type == 'balance'">{{ '10' }}</template>
              <template v-if="item.type == 'integral'">{{ '20' }}</template>
            </div>
            <div
              class="text"
              :style="{
