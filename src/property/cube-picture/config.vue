          ...
          <CommonCard title="组件设置">
                ...
                <VanRow class="row">
                  <template v-for="index of data.type + 2" :key="index">
                    <VanCol :span="24 / (data.type + 2)">
                      <div
                        class="row-item"
                        :class="activeImgIndex === index - 1 ? 'active' : ''"
                        @click="activeImgIndex = index - 1"
                      >
                        <div class="empty">
                          <div>
                            宽度:
              ...
              <template v-else-if="data.type === CubePictureTypeEnum['一左二右']">
                <VanRow class="row">
                  <VanCol :span="12">
                    <div
                      class="row-item"
                      :class="activeImgIndex === 0 ? 'active' : ''"
                      style="height: 100%"
                      @click="activeImgIndex = 0"
                    >
                      <div class="empty">
                        <div>
                          宽度:
                  ...
                  <VanCol :span="12">
                    <template v-for="index of 2" :key="index">
                      <div
                        class="row-item"
                        :class="activeImgIndex === index ? 'active' : ''"
            ...
            <div class="item">
              ...
              <div class="item-right">
                <CommonSelectLink
                  :key="data.imgList[activeImgIndex].uuid"
                  :link="data.imgList[activeImgIndex]"
                />
              </div>
            </div>
          </CommonCard>
